...
The same runner supplies its installed Node.js executable and must report major version 24 before the release can proceed; packaged Node and Electron binaries remain independently pinned and SHA-256 verified by `runtime-lock.json`.
